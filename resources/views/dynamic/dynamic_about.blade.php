            ...
            {{-- <section class="section-wrapper">
                <div class="container">
                    <div class="about-pg-section">
                        @if (isset($aboutSections[0]))
                            <div class="about-pg-diff">
                                <div class="about-des">
                                    <p class="para-head">{{ $aboutSections[0]['description'] }}</p>
                                </div>
                            </div>
                            <div class="img-about-pg">
                                <img class="img" src="{{ $aboutSections[0]['image'] }}">
                            </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="top-sectiom-title">
                        <div class="top-title">
                            ...
                            <p>Our story is a tapestry of passion, innovation, and commitment. From our humble beginnings to
                    ...
                    {{--  above is the dynamic section of team members  thank you --}}
