...
{{-- Articles news notices --}}
<li class="nav-item">
    <a class="nav-link" href="{{ backpack_url('article') }}">
        <i class="la la-file-text nav-icon"></i> Articles/News-Notices
    </a>
</li>
...
<x-backpack::menu-dropdown title="Home Control" icon="la la-home">
    ...
    <x-backpack::menu-dropdown-item title="Contact" icon="la la-phone" :link="backpack_url('contact-section-home')" />
    <x-backpack::menu-dropdown-item title="Logo" icon="la la-cog" :link="backpack_url('logo')" />
</x-backpack::menu-dropdown>

<x-backpack::menu-dropdown title="Media Folder" icon="la la-album ">
    <x-backpack::menu-dropdown-item title=" folders" icon="la la-folder" :link="backpack_url('image-folder')" />
    <x-backpack::menu-dropdown-item title="Images" icon="la la-image" :link="backpack_url('image')" />
</x-backpack::menu-dropdown>
